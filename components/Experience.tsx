...
const Experience = () => {
  return (
    <div className="py-6 flex flex-col gap-4">
      ...
      <div className="text-white flex justify-between items-center px-16 border-y border-dashed border-white/30 ">
        <p className='font-roboto-mono tracking-tight font-light text-[16px] hover:bg-white/10 transition-all duration-100'>Open to Full-time opportunites / freelance / internships. </p>
      </div>
    </div>
  )
}
