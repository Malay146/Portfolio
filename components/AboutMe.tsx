  ...
  return (
    <div className="py-6 flex flex-col gap-4">
      <div className="text-white flex justify-between items-center px-16 border-y border-dashed border-white/30">
        ...
        <Button href="/MALAY_PATEL_RESUME.pdf" className="font-inter text-[14px] tracking-tight font-medium flex items-center gap-0.5 hover:bg-white/10 transition-colors">
          <FileIcon />
          Resume
        </Button>
      </div>
